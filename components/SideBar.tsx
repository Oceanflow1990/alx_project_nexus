  ...
  return (
    ...
    >
      <motion.div
       ...
       bg-darkColor text-white/70 h-full p-10 border-r border-r-white flex flex-col gap-6"
      >
        ...
        <div className="flex flex-col gap-3.5 text-base font-semibold tracking-white">
          {headerData?.map((item) => (
            <Link
              onClick={onClose}
              key={item?.title}
              href={item?.href}
              className={`hover:text-gray-600 hoverEffect w-14 ${
